...
| [aws_iam_policy.github_actions_eks_ro](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
...
| [aws_iam_role_policy_attachment.github_actions_pa_eks](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| [tls_certificate.github_oidc_tls_certificate](https://registry.terraform.io/providers/hashicorp/tls/latest/docs/data-sources/certificate) | data source |

## Inputs

| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| <a name="input_plubic_subnet_1a"></a> [plubic\_subnet\_1a](#input\_plubic\_subnet\_1a) | Subnet to create EKS cluster AZ 1a | `string` | n/a | yes |
| <a name="input_plubic_subnet_1b"></a> [plubic\_subnet\_1b](#input\_plubic\_subnet\_1b) | Subnet to create EKS cluster AZ 1b | `string` | n/a | yes |
